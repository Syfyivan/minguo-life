...
(function (root) {
  ...
  function makeCareerEpisode(state, routeKey, startYear, endYear, source, status) {
    ...
    return {
      ...
      supervisor: profile ? profile.supervisor : null,
      colleague: profile ? profile.colleague : null,
      publicPerson: profile ? profile.publicPerson : null,
      terms: profile ? profile.terms : null,
      duties: profile ? profile.duties : null,
  ...
  function syncEconomicRouteEpisode(state, episode) {
    ...
    upsertEntity(economicLife.positions, positionId, {
      ...
      colleague: profile.colleague || null,
    ...
    if (profile.business) {
      ...
      upsertEntity(economicLife.enterprises, enterpriseId, {
        ...
        employees: Number(profile.business.employees || 0),
      ...
      upsertEntity(economicLife.employments, 'employment:' + episode.routeKey + ':' + episode.startedYear, {
        ...
        supervisor: profile.supervisor || null,
        colleague: profile.colleague || null,
        publicPerson: profile.publicPerson || null,
        terms: profile.terms,
        duties: profile.duties || null,
        startedYear: episode.startedYear,
        endedYear: episode.endedYear,
        status: episode.status,
        source: episode.source,
